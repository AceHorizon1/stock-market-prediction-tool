...
def initialize_git_repo():
    ...
    # Make initial commit
    if not run_command('git commit -m "Initial commit: Stock Market Prediction Tool"', "Making initial commit"):
        return False
...
def show_github_instructions():
    ...
    print("   - Description: A comprehensive AI-powered tool for predicting stock market movements")
    ...
    print("   git remote add origin https://github.com/YOUR_USERNAME/stock-market-prediction-tool.git")
