...
class DataCollector:
    ...
    def __init__(
        self, alpha_vantage_key: Optional[str] = None, fred_key: Optional[str] = None
    ):
    ...
    def get_multiple_stocks(
        self, symbols: List[str], period: str = "5y", interval: str = "1d"
    ...
    def get_market_data(self, symbols: List[str] = None) -> pd.DataFrame:
        ...
        if symbols is None:
            symbols = [
                ...
                "^TNX",
                "^TYX",
            ]  # S&P 500, Dow, NASDAQ, VIX, 10Y, 30Y
        ...
        if include_market_data:
            ...
            if not market_data.empty:
                ...
                combined_data = combined_data.merge(
                    market_data, left_index=True, right_index=True, how="left"
                )
